    ...
    <div class="container" style="margin-top: 280px; width: 650px; background-color: #4d4d4d; border-radius: 100px; padding: 10px; opacity: .9">
      ...
      <form class="cambiar_user" action="cambiar_user.php" method="post">
        ...
        <div class="row">
          <div class="col-md-3"></div>
          <div class="col-md-3">
            <button class="btn btn-success btn-sm" type="submit" name="cambiar" style="font-size: 13px; margin-left: 313px; margin-bottom: 5px" onclick="return confirm('¿Esta seguro/a que desea modificar el nombre de su cuenta de usuario?')"><strong><span class="glyphicon glyphicon-ok"></span> Cambiar</strong></button>
          </div>
          <div class="col-md-3">
