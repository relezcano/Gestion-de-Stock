    ...
    <div class="container" style="margin-top: 150px; width: 650px; background-color: #4d4d4d; border-radius: 100px; padding: 10px; opacity: .9">
      ...
      <form class="nuevo_user" action="nuevo_user.php" method="post">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <button class="btn btn-success btn-sm" type="submit" name="guardar" style="font-size: 13px; margin-left: 213px; margin-bottom: 5px"><strong><span class="glyphicon glyphicon-ok"></span> Guardar</strong></button>
          </div>
