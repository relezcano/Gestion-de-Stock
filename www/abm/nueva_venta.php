	...
	<body>
      ...
      <form class="alta" action="nueva_venta.php" method="post" style="margin-left: 50px">
				...
				<div class="row">
					...
					<div class="col-md-3">
						<button style="margin-left: 30px; font-family: verdana; font-weight: bolder" type="button" name="cancelar" onclick="location.href = 'ventasGestion.php';" class="btn btn-danger btn-md"><span class="glyphicon glyphicon-chevron-left"></span><strong> VOLVER</strong></button>
					</div>
						<div class="col-md-3"></div>
					</div>
				</form>
