...
?>
        <div id="mySidenav" class="sidenav">
          ...
          <button class="btn btn-warning" style="color: #ffffff; border-radius: 20px; border-style: outset; border-width: medium; margin-left: 30px; margin-bottom: 20px; font-size: 20px; font-weight: bolder; padding-left: 45px; padding-right: 47px;" onclick="window.open('abm/cambiar_user.php')">Cambiar Usuario</button> <br>
          <button class="btn btn-warning" style="color: #ffffff; border-radius: 20px; border-style: outset; border-width: medium; margin-left: 30px; margin-bottom: 20px; font-size: 20px; font-weight: bolder; padding-left: 25px; padding-right: 27px;" onclick="window.open('abm/cambiar_pass.php')">Cambiar Contraseña</button> <br>
          <button class="btn btn-warning" style="color: #ffffff; border-radius: 20px; border-style: outset; border-width: medium; margin-left: 30px; font-size: 20px; margin-bottom: 20px; font-weight: bolder" onclick="window.open('abm/nuevo_user.php')">Agregar Nuevo Usuario</button> <br>
          <button class="btn btn-warning" style="color: #ffffff; border-radius: 20px; border-style: outset; border-width: medium; margin-left: 30px; font-size: 20px; margin-bottom: 20px; font-weight: bolder; padding-left: 40px; padding-right: 40px;" onclick="window.open('abm/cambiar_permisos.php')">Cambiar Permisos</button> <br>
          <button class="btn btn-danger" style="color: #ffffff; border-radius: 20px; border-style: outset; border-width: medium; margin-left: 30px; margin-bottom: 20px; font-size: 20px; font-weight: bolder; padding-left: 65px; padding-right: 65px;" onclick="window.location.replace('include/logout.php')">Cerrar Sesión</button> <br>
        </div>
