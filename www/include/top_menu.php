<div class="container-fluid" style="background-color:#4d4d4d; padding: 5px">
  ...
  <button class="btn btn-warning" onclick="window.open('ventas.php')" target="_blank"><Strong>Ventas</Strong></button>

  <button class="btn btn-warning" onclick="window.open('stock.php')" target="_blank"><Strong>Stock</Strong></button>

  <button class="btn btn-warning" onclick="window.open('ant_prov.php')" target="_blank"><Strong>Anticipo de Proveedores</Strong></button>

  <button class="btn btn-warning" onclick="window.open('ingresos.php')" target="_blank"><Strong>Ingreso de Mercaderia</Strong></button>

  <button class="btn btn-warning" onclick="window.open('deudores.php')" target="_blank"><Strong>Deudores</Strong></button>
