...
<div class="container-fluid" style="background-color:#4d4d4d; padding: 5px">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content" style="background-color: #fff7e6; border-top-right-radius: 45px; border-bottom-right-radius: 30px; border-bottom-left-radius: 30px; width: 180px">
      <a onclick="windowOpener('abm/productos.php', 'abm_productos', 'abm_productos')" target="_blank" style="border-top-right-radius: 100px"><strong>Productos</a>
      <a onclick="windowOpener('abm/proveedores.php', 'abm_proveedores', 'abm_proveedores')" target="_blank"><strong>Proveedores</strong></a>
      <a onclick="windowOpener('abm/lotes.php', 'abm_lotes', 'abm_lotes')" target="_blank"><strong>Lotes</strong></a>
      <a onclick="windowOpener('abm/pedidos.php', 'abm_pedidos', 'abm_pedidos')" target="_blank"><strong>Pedidos</strong></a>
      <a onclick="windowOpener('abm/ventasGestion.php', 'abm_ventas', 'abm_ventas')" target="_blank"><strong>Ventas</strong></a>
      <a onclick="windowOpener('abm/clientes.php', 'abm_clientes', 'abm_clientes')" target="_blank"><strong>Clientes</strong></a>
      <a onclick="windowOpener('abm/deudas.php', 'abm_deudas', 'abm_deudas')" target="_blank" style="border-bottom-left-radius: 30px; border-bottom-right-radius: 30px"><strong>Deudas</strong></a>
    </div>
