  ...
  <body style="max-width: 920px; min-width: 920px;">
    ...
    <div class="container">
      ...
      <form method="post" name="ventas">
        ...
        <div id="topDiv">
          <h2 style="font-size: 38px">Ventas</h2>

          <div class="row" style="float: left; width: 100%; margin-left: 0%; margin-bottom: 5px">
            <label onclick="window.open('select_Client.php');" style="cursor: pointer"><strong>Cliente: </strong></label>
            <input type="text" name="cliente" placeholder="Ingrese id del cliente" style="width: 135px; color: black; border-radius: 30px; padding: 2px" onkeyup="setClientDataParent(this);" onkeypress="return restrictCharacters(this, event, digitos)">
          </div>
        ...
        <div class="row" style="margin: 0;margin-top: 5px">
          ...
          <div class="col-md-5">
            ...
            <div class="row" style="margin-bottom: 0px; margin-right: 0px">
              <div class="col-md-12" style="border-top: solid 2px grey;border-left: solid 2px grey;border-right: solid 2px grey">
                <strong>Pago:</strong><span style="margin-left: 35%">$</span><input type="text" name="Pago" id="invis_input" style="width: 120px" onkeyup="calcVuelto();" onkeypress="return restrictCharacters(this, event, precios)">
              </div>
            </div>
          ...
          <div class="row" style="margin: 0;margin-top: 0;">
            <div style="margin: 0 auto; margin-bottom: 5px;margin-top: 5px; width: 195px" class="center-block">
              <button type="button" class="btn btn-success" name="close" onclick="endSellProcess('load');"><span class="glyphicon glyphicon-ok"></span> Cargar</button>

              <button type="button" class="btn btn-danger" name="cancel" onclick="endSellProcess('cancel');"><span class="glyphicon glyphicon-remove"></span> Cancelar</button>
            </div>
