...
<div class="container-fluid">
  ...
  <div class="formulario">
    ...
    <div class="row">
      ...
      <div class="col-sm-3">
        <input class="form-control" style="width: 210px; margin-bottom: 5px" type="text" name="name" value="<?echo $monto;?>">
      </div>
      <div class="col-sm-5"></div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-3">
        <input class="form-control" style="width: 210px; margin-bottom: 5px" type="text" name="phone" value="<?echo $idV;?>">
      </div>
      <div class="col-sm-5"></div>
    </div>
    ...
    <div class="row">
      ...
      <div class="col-sm-3">
        <input class="form-control" style="width: 210px; margin-bottom: 5px" type="text" name="phone" value="<?echo $idC;?>">
      </div>
      <div class="col-sm-5"></div>
    </div>
